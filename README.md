...
# 🌐 Demonstração Online
Você pode testar o FinDash funcionando diretamente no seu navegador aqui:
👉 Acesse o FinDash Online(https://aalexdev.io/FinDash/) 
...
Controle de Transações: Adição rápida de novas entradas ou saídas.

Gerenciamento de Metas: Acompanhamento visual do progresso para alcançar objetivos de poupança.
...
Chart.js: Biblioteca utilizada para a renderização dos gráficos interativos.
